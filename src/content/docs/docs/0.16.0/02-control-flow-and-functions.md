---
title: "02. 제어 흐름 및 함수 (v0.16.0)"
description: "Zig 0.16.0 공식 레퍼런스 - if문, while/for 반복문, switch문 및 함수 선언 규칙."
---
...
### `for` 루프 (v0.16.0 멀티-오브젝트 순회)
Zig 0.16.0의 `for`는 하나 이상의 슬라이스/배열을 동시에 인덱스와 함께 순회할 수 있습니다:
